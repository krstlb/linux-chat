...
QT_MOC_LITERAL(1, 7, 16), // "recvBufferSignal"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "rbuf"
QT_MOC_LITERAL(4, 30, 18), // "createThreadSignal"
QT_MOC_LITERAL(5, 49, 11) // "receiveData"

    },
    "Thread\0recvBufferSignal\0\0rbuf\0"
    "createThreadSignal\0receiveData"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recvBufferSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->createThreadSignal(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::recvBufferSignal)) {
                *result = 0;
            }
        }
        {
            typedef void (Thread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::createThreadSignal)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Thread::recvBufferSignal(QString _t1)
{
...
// SIGNAL 1
void Thread::createThreadSignal()
{
