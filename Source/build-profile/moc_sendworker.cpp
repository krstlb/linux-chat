...
QT_MOC_LITERAL(3, 24, 16), // "updateTextWindow"
QT_MOC_LITERAL(4, 41, 8), // "finished"
QT_MOC_LITERAL(5, 50, 6) // "doWork"

    },
    "SendWorker\0receiveData\0\0updateTextWindow\0"
    "finished\0doWork"
};
...
void SendWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateTextWindow((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SendWorker::receiveData)) {
                *result = 0;
            }
        }
        {
            typedef void (SendWorker::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SendWorker::updateTextWindow)) {
                *result = 1;
            }
        }
        {
            typedef void (SendWorker::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SendWorker::finished)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void SendWorker::receiveData()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void SendWorker::updateTextWindow(QString _t1)
{
